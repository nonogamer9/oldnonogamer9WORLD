                ...
                },
                {
                    ...
                    value: function (a, b, c) {
                        ...
                        (c = c || !1),
                            ...
                            (a = replaceAll(a, "{SPEED}", this.userPublic.speed)),
                            (a = replaceAll(a, "{PITCH}", this.userPublic.pitch)),
                            "undefined" != typeof b ? ((b = replaceAll(b, "{NAME}", this.userPublic.name)), (b = replaceAll(b, "{COLOR}", this.color)), ((b = replaceAll(b, "{SPEED}", this.userPublic.speed)), ((b = replaceAll(b, "{PITCH}", this.userPublic.pitch))) : (b = a.replace("&gt;", "")),
                            (a = linkify(a));
