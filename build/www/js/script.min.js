...
function loadBonzis(a) {
  loadQueue.loadManifest([
    ...
    { id: "bonzispongebob", src: "./img/bonzi/spongebob.png" },
    { id: "bonzicreeper", src: "./img/bonzi/creeper.png" },
    { id: "bonziwinserver2003", src: "./img/bonzi/winserver2003.png" },
    { id: "bonzisteve", src: "./img/bonzi/steve.png" },
    { id: "bonzisquidward", src: "./img/bonzi/squidward.png" },
    { id: "bonzipatrick", src: "./img/bonzi/patrick.png" },
    { id: "bonziwin95", src: "./img/bonzi/win95.png" },
    { id: "bonzimrkrabs", src: "./img/bonzi/mrkrabs.png" },
    { id: "bonzikaito", src: "./img/bonzi/kaito.png" },
...
function login() {
  socket.emit(window.guid, { name: $("#login_name").val(), room: $("#login_room").val() }), setup();
}
function errorFatal() {
